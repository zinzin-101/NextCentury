...
void IngameUI::initUI(std::list<DrawableObject*>& objectsList) {
    ...
    healthBar->getTransform().setPosition(glm::vec3(0.0f, 3.0f, 0.0f));
    ...
    staminaBar->getTransform().setPosition(glm::vec3(0.0f, 3.0f, 0.0f));
...
void IngameUI::updateUI(PlayerObject& playerObject, glm::vec3 camPos) {
    ...
    healthBar->getTransform().setPosition(glm::vec3(leftAlignedXH, playerPos.y + 1.1f, 0.0f));
    ...
    staminaBar->getTransform().setPosition(glm::vec3(leftAlignedXS, playerPos.y + 1.0f, 0.0f));
}