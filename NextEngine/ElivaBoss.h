...
namespace ElivaStat {
	...
	constexpr int MAX_HEALTH = 400;
	constexpr int HEALTH_TO_BEGIN_SERUM_INJECT = MAX_HEALTH * 0.7f;
	constexpr int HEALTH_TO_BEGIN_FURY = MAX_HEALTH * 0.4f;
	...
	constexpr float RAPID_BURST_TIME_PER_FRAME = 0.13f;
